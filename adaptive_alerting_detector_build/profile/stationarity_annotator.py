...
def annotate_stationarity(stationarity_result: StationarityResult, timeseries_name: str = 'timeseries',
                          significance: str = DEFAULT_SIGNIFICANCE, max_adf_pvalue=DEFAULT_MAX_ADF_PVALUE) -> StationarityReport:
    """
    ...
    return StationarityReport(adf_result, adf_summary, p_value_display, stationarity_display, is_stationary,
                              test_stat_display)
